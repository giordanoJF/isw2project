...
\begin{enumerate}
    ...
    \item \textbf{Milestone 2 -- Identificazione di modelli accurati}: Addestramento e valutazione
    di classificatori per la predizione della
    bugginess tramite 10-times 10-fold cross-validation (60 combinazioni).

    \item \textbf{Milestone 3 -- Analisi dell'impatto dei code smell}: analisi
