...
contare le violazioni (\emph{Nsmells}). Le classi con LOC $< 100$ sono escluse per
scarsità di metodi e opportunità di refactoring trascurabili;
le restanti 819 vengono ordinate per Nsmells decrescente. La selezione segue la formula
del docente: $G \Rightarrow 7 \bmod 5 = 2$, caso~2 $\Rightarrow$ rank~$3$ e rank~$817$
su $N = 819$ (Tabella~\ref{tab:m4-selected}).
