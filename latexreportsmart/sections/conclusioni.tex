...
\begin{description}
  ...
  Questo è un segnale potenzialmente negativo: il profilo di rischio peggiora
  leggermente rispetto a $C_0$.
  Tuttavia la predizione rimane \texttt{false} in tutti i casi: le variazioni sono
  troppo marginali per attraversare la soglia decisionale del modello
